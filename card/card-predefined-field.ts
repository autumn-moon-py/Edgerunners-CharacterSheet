...
function mergeCustomFields(_tempBatchId?: string, tempDefinitions?: CustomFieldsForBatch): CustomFieldNamesStore {
...
function mergeVariantTypes(_tempBatchId?: string, tempDefinitions?: VariantTypesForBatch): VariantTypesForBatch {
  const store = useUnifiedCardStore.getState();
