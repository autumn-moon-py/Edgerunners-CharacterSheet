...
set "NEXT_PUBLIC_ENABLE_CARD_MANAGER=true"

echo [INFO] Starting Next.js dev server with card manager enabled, bound to 0.0.0.0:!DEV_PORT! in a new window...
...
start "DaggerHeart Dev Server (Show Card Manager)" /d "%~dp0" cmd /k "pnpm exec next dev -H 0.0.0.0 -p !DEV_PORT!"
