...
function Card({
  ...
  const domainPriceLabel = standardCard?.type === CardType.Domain ? formatDomainCardPrice(standardCard.level) : null
  const displayItem3 = standardCard?.type === CardType.Domain
    ? formatDomainCardLoadLabel(standardCard.cardSelectDisplay?.item3) || ""
    : standardCard?.cardSelectDisplay?.item3 || ""
